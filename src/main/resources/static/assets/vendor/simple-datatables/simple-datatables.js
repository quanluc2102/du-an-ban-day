        ...
        1: [function (require, module, exports) {
            (function (global) {
                (function () {
                    ...
                    function d(t, e, s) {
                        var i, n, a, o = e[s._const.action], d = e[s._const.route];
                    ...
                    var h = function (t) {
                        ...
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = v(s.length, !1), a = v(i.length, !1), o = [], r = function () {
                            ...
                            var t = function (t, e, s, i) {
                                ...
                                for (var u = 0; u < o; u++) for (var f = t[u], m = 0; m < r; m++) {
                                    var g = e[m];
                    ...
                    var $ = {
                        ...
                        for (var a = new RegExp(O), o = null, r = !1; !r;) if (null === (o = a.exec(t))) r = !0; else if (o[0].trim()) if (o[1]) {
                            var l = o[1].trim(), d = [l, ""];
                        ...
                        return t.prototype.init = function () {
                            ...
                            for (var a, o, r, l, d, c, h = function (t, e, s) {
                                var i = t.childNodes ? v(t.childNodes.length, !0) : [],
                                    n = e.childNodes ? v(e.childNodes.length, !0) : [], a = 0;
                                return s.forEach((function (t) {
                                    for (var e = t.oldValue + t.length, s = t.newValue + t.length, o = t.oldValue; o < e; o += 1) i[o] = a;
                                    for (o = t.newValue; o < s; o += 1) n[o] = a;
                                    a += 1
                                })), {gaps1: i, gaps2: n}
                            }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), g = [], _ = 0, w = 0; _ < f; w += 1, _ += 1) if (!n || !0 !== u[_] && !0 !== p[_]) if (!0 === u[_]) if ("#text" === (l = t.childNodes[w]).nodeName) if ("#text" === e.childNodes[_].nodeName) {
                                if (l.data !== e.childNodes[_].data) {
                                    for (c = w; t.childNodes.length > c + 1 && "#text" === t.childNodes[c + 1].nodeName;) if (c += 1, e.childNodes[_].data === t.childNodes[c].data) {
                                        d = !0;
                                        break
                                    }
                            ...
                            } else g.push((new y).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)), u.splice(_, 1), f = Math.min(u.length, p.length), _ -= 1; else g.push((new y).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, m(l))), u.splice(_, 1), f = Math.min(u.length, p.length), _ -= 1; else if (!0 === p[_]) "#text" === (l = e.childNodes[_]).nodeName ? (g.push((new y).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)), u.splice(_, 0, !0), f = Math.min(u.length, p.length), w -= 1) : (g.push((new y).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, m(l))), u.splice(_, 0, !0), f = Math.min(u.length, p.length), w -= 1); else if (u[_] !== p[_]) {
                    ...
                    R.exports = function () {
                        ...
                        var M = function () {
                            ...
                            return b.parse = function (t) {
                                ...
                                var s = this, i = !!D.u(e) || e, c = D.p(t), p = function (t, e) {
                                ...
                                switch (c) {
                                    ...
                                    case l:
                                        var _ = this.$locale().weekStart || 0, w = (m < _ ? m + 7 : m) - _;
                                ...
                                var s, l = D.p(t), c = "set" + (this.$u ? "UTC" : ""),
                                ...
                                var i = t || "YYYY-MM-DDTHH:mm:ssZ", n = D.z(this), a = this.$H, o = this.$m,
                                ...
                                var f, m = D.p(u), g = N(i), b = (g.utcOffset() - this.utcOffset()) * e, v = this - g,
                                    _ = D.m(this, g);
                        ...
                        t.headings ? o.headings = t.headings.map((t => z(t))) : e?.tHead ? o.headings = Array.from(e.tHead.querySelectorAll("th")).map(((t, e) => {
                            const o = (t => {
                                ...
                                return s = !e.childNodes || 1 === e.childNodes.length && "#text" === e.childNodes[0].nodeName ? {
                                    data: t.innerText,
                                    type: "string"
                                } : {data: e.childNodes, type: "html", text: i(e)}, s
                            })(t);
                        ...
                        if (t.data ? o.data = t.data.map((t => t.map(((t, e) => F(t, s[e]))))) : e?.tBodies?.length && (o.data = Array.from(e.tBodies[0].rows).map((t => Array.from(t.cells).map(((t, e) => {
                            const i = t.dataset.content ? F(t.dataset.content, s[e]) : ((t, e) => {
                                ...
                                switch (e.type) {
                                    ...
                                    default:
                                        s = {
                                            data: D(t, {valueDiffing: !1}).childNodes || [],
                                            text: t.innerText,
                                            order: t.innerText
                                        }
                                }
                    ...
                    const Q = {
                        ...
                        labels: {
                            ...
                            searchTitle: "Tìm Kiếm Dữ Liệu Trong Bảng",
                            perPage: "Bản Ghi Mỗi Trang",
                            noRows: "Không Dữ Liệu",
                            noResults: "Không có kết quả phù hợp với tìm kiếm của bạn.",
                            info: "Hiển Thị {start} Đến {end} Trong {rows} Bản Ghi"
                        },
                    ...
                    class K {
                        ...
                        keydown(t) {
                            if (this.modalDOM) {
                                if ("Escape" === t.key) this.options.closeModal(this) && this.closeModal(); else if ("Enter" === t.key) if (this.editingCell) {
                        ...
                        editCellModal() {
                            ...
                            r.focus(), r.selectionStart = r.selectionEnd = r.value.length, o.addEventListener("click", (t => {
                                const e = t.target;
                                if (e instanceof Element) if (e.hasAttribute("data-editor-close")) {
                        ...
                        editRowModal() {
                            const t = this.data.row,
                                ...
                                i = s("div", {class: this.options.classes.modal, html: e}), a = i.firstElementChild;
                            if (!a) return;
                        ...
                        saveRow(t, e) {
                            ...
                            this.dt.data.data[this.data.rowIndex] = this.dt.data.data[this.data.rowIndex].map(((e, s) => {
                                ...
                                const i = this.dt.columns.settings[s].type || this.dt.options.type,
                                    n = t[o(s, this.dt.columns.settings)], a = n.trim();
                                let r;
                                if ("number" === i) r = {data: parseFloat(a)}; else if ("boolean" === i) r = ["", "false", "0"].includes(a) ? {
                                    data: !1,
                                    text: "false",
                                    order: 0
                                } : {
                                    ...
                                    text: n,
                                    order: n
                                }; else if ("string" === i) r = {data: n}; else if ("date" === i) {
                        ...
                        rowRender(t, e, s) {
                            ...
                            if (this.editingCell) {
                                ...
                                const o = a(i, this.dt.columns.settings), r = t[o];
                    ...
                    exports.DataTable = class {
                        constructor(t, e = {}) {
                            ...
                            const i = {...Q.labels, ...e.labels}, n = {...Q.classes, ...e.classes};
                            this.options = {
                                ...Q, ...e,
                                labels: i,
                                classes: n
                            }, this._initialInnerHTML = this.options.destroyable ? this.dom.innerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new T({valueDiffing: !1}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }

                        init() {
                            if (this.initialized || this.dom.classList.contains(this.options.classes.table)) return !1;
                            this._virtualDOM = D(this.dom, {valueDiffing: !1}), this._tableAttributes = {...this._virtualDOM.attributes}, this.rows = new J(this), this.columns = new W(this), this.data = U(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
                        ...
                        _renderSeparateHeader() {
                            ...
                            let e = {
                                ...
                                childNodes: [{
                                    nodeName: "THEAD",
                                    childNodes: [A(this.data.headings, this.columns.settings, this.columns._state, this.options, {unhideHeader: !0})]
                                }]
                            };
                            if (this.options.tableRender) {
                        ...
                        const i = {download: !0, skipColumn: [], replacer: null, space: 4, ...s},
                            n = t => !i.skipColumn.includes(t) && !e.columns.settings[t]?.hidden;
                        let a = [];
                        if (i.selection) if (Array.isArray(i.selection)) for (let t = 0; t < i.selection.length; t++) a = a.concat(e.pages[i.selection[t] - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.data))))); else a = a.concat(e.pages[i.selection - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.data))))); else a = a.concat(e.data.data.map((t => t.filter(((t, e) => n(e))).map((t => t.data)))));
                        ...
                        const i = {download: !0, skipColumn: [], tableName: "myTable", ...s},
                            n = t => !i.skipColumn.includes(t) && !e.columns.settings[t]?.hidden;
                        let a = [];
                        if (i.selection) if (Array.isArray(i.selection)) for (let t = 0; t < i.selection.length; t++) a = a.concat(e.pages[i.selection[t] - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.text ?? t.data))))); else a = a.concat(e.pages[i.selection - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.text ?? t.data))))); else a = a.concat(e.data.data.map((t => t.filter(((t, e) => n(e))).map((t => t.data)))));
                        const o = e.data.headings.filter(((t, e) => n(e))).map((t => t.text ?? String(t.data)));
                        if (a.length) {
