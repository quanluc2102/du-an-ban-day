                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <c:forEach items="${listHoaDon}" var="hd">
                                    <tr>
                                        ...
                                        <td>${hd.trangThai}</td>
                                        <td><button class="btn btn-danger"><a href="/hoa_don/delete?id=${hd.id}" style="text-decoration: none;color: white">Delete</a></button>
                                            <button class="btn btn-primary"><a href="/hoa_don/detail?id=${hd.id}" style="text-decoration: none;color: white">Detail</a></button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
