                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <c:forEach items="${listSP}" var="sp">
                                    <tr>
                                        ...
                                        <td><button class="btn btn-danger"><a href="/sanpham/delete?id=${sp.id}" style="text-decoration: none;color: white">Delete</a></button>
                                            <button class="btn btn-primary"><a href="/sanpham/detail?id=${sp.id}" style="text-decoration: none;color: white">Detail</a></button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
