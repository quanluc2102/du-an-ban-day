                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <c:forEach items="${listSPDM}" var="spdm">
                                    <tr>
                                        ...
                                        <td><button class="btn btn-danger"><a href="/san_pham_danh_muc/delete?id=${sp.id}" style="text-decoration: none;color: white">Delete</a></button>
                                            <button class="btn btn-primary"><a href="/san_pham_danh_muc/detail?id=${sp.id}" style="text-decoration: none;color: white">Detail</a></button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
