                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                <c:forEach items="${listSPDM}" var="spdm">
                                    <tr>
                                        <th scope="row">${spdm.id}</th>
                                        <td>${spdm.sanPham.ten}</td>
                                        <td>${spdm.danhMuc.ten}</td>
                                        <td><button class="btn btn-danger"><a href="/san_pham_danh_muc/delete?id=${spdm.id}" style="text-decoration: none;color: white">Delete</a></button>
                                            <button class="btn btn-primary"><a href="/san_pham_danh_muc/detail?id=${spdm.id}" style="text-decoration: none;color: white">Detail</a></button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form:form cssClass="row g-3" modelAttribute="SanPhamDanhMuc" method="post" action="update/${spdm.id}">
                        <div class="col-md-12">
                            <label class="form-label">Sản phẩm</label>
                            <form:select cssClass="form-control" path="sanPham">
