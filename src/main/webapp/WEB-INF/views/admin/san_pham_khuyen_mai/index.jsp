...
<div class="pagetitle">
    <h1>Quản Lý sản phẩm khuyến mại</h1>
    <nav>
        <ol class="breadcrumb">
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <tbody>
                                    <c:forEach items="${listSPKM}" var="spkm">
                                        <tr>
                                            <td scope="row">${spkm.id}</td>
                                            <td>${spkm.sanPhamId.ten}</td>
                                            <td>${spkm.khuyenMaiId.ten}</td>
                                            <td>
                                                <a href="/san-pham-khuyen-mai/xoa/${spkm.id}" class="btn btn-danger">Delete</a>
                                                <a href="/san-pham-khuyen-mai/detail/${spkm.id}" class="btn btn-success">Detail</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                ...
                                <div class="text-center">
                                    <a href="/san-pham-khuyen-mai/create" class="btn btn-primary" type="submit">Save</a>
                                </div>
                            </form>
                        </div>
