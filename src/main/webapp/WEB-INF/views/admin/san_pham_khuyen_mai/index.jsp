                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <c:forEach items="${listSPKM}" var="spkm">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/san_pham_khuyen_mai/xoa/${spkm.id}" class="btn btn-danger">Delete</a>
                                                <a href="/san_pham_khuyen_mai/detail/${spkm.id}" class="btn btn-success">Detail</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                ...
                                <div class="text-center">
                                    <a href="/san_pham_khuyen_mai/create" class="btn btn-primary" type="submit">Save</a>
                                </div>
                            </form>
                        </div>
